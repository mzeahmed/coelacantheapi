...
$userRoutes = [
    $router->get(API_BASE_SLUG . '/users/page/:page', 'App\Http\Controllers\Api\UserController@index')->addParam('page'),
    ...
    $router->get(API_BASE_SLUG . '/posts/page/:page', 'App\Http\Controllers\Api\PostController@index')->addParam('page'),
